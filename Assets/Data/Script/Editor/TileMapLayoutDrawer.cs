...
[CustomPropertyDrawer(typeof(TileMapLayout))]
public class TileMapPropertyDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        int colCount = rowCount > 0 ? rows.GetArrayElementAtIndex(0).FindPropertyRelative("row").arraySize : 0;
